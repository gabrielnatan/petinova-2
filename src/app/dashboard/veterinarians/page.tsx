          ...
          <div className="flex flex-col md:flex-row gap-4">
            ...
            <div className="flex items-center space-x-2">
              ...
              <select
                ...
                className="px-3 py-2 bg-background-secondary border border-border rounded-lg text-text-primary focus:border-border-focus focus:outline-none transition-colors duration-200"
              >
